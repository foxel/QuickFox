...
$lang['CONFIG_COMMON_CSSSEP']='Отправлять CSS отдельно.';
$lang['CONFIG_COMMON_CSSSEP_MORE']='При включение данной опции QuickFox не будет встраивать CSS стиль в страницу.
 Параметры стиля будут запрашиваться клиентом в отдельном потоке. В таком случае CSS-данные могут быть кэшированы на стороне клиента.';
